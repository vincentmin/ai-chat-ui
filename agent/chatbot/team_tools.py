...
def build_team_instructions(agent_key: str, team_agents: list[str]) -> str | None:
    ...
    return (
        ...
        f'{teammate_lines}\n\n'
        'Messages from other agents appear as user messages with a structured '
        'header like "[[mailbox {"sender":"<agent>"}]]" followed by '
        'the actual message body. When another agent asks you to do '
        ...
        'woken up with their reply as a new mailbox message. '
